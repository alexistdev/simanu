...
public class ReportPSU extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_psu from psu";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_psu");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_psu from psu";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "PSU001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_psu");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "PSU00"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                a[0] = rs.getString("id_psu");
                a[1] = rs.getString("kode_psu");
                a[2] = rs.getString("nama_psu");
                a[3] = rs.getString("merek_psu");
                a[4] = rs.getString("harga_psu");
                a[5] = rs.getString("stock_psu");
                tabelMb.addRow(a);
            }
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_psu !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("= Master Data PSU = ");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update psu SET kode_psu ='"+txtKode.getText()+"', nama_psu ='"+txtNama.getText()+"', merek_psu ='"+cmbMerek.getSelectedItem()+"',harga_psu ='"+txtHarga.getText()+"', stock_psu ='"+txtStock.getText()+"' WHERE id_psu ='"+txtID.getText()+"'";
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from psu WHERE id_psu='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into psu(kode_psu,nama_psu,merek_psu,harga_psu,stock_psu) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
