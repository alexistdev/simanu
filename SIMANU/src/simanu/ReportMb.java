...
public class ReportMb extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_mb from motherboard";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_mb");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_mb from motherboard";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "MB0001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_mb");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "MB000"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                a[0] = rs.getString("id_mb");
                a[1] = rs.getString("kode_mb");
                a[2] = rs.getString("nama_mb");
                a[3] = rs.getString("merek");
                a[4] = rs.getString("harga_mb");
                a[5] = rs.getString("stock_mb");
                tabelMb.addRow(a);
            }
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_mb !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update motherboard SET kode_mb ='"+txtKode.getText()+"', nama_mb ='"+txtNama.getText()+"', merek ='"+cmbMerek.getSelectedItem()+"',harga_mb ='"+txtHarga.getText()+"', stock_mb ='"+txtStock.getText()+"' WHERE id_mb ='"+txtID.getText()+"'";
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from motherboard WHERE id_mb='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into motherboard(kode_mb,nama_mb,merek,harga_mb,stock_mb) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
