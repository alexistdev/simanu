...
public class ReportMonitor extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_mnt from monitor";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_mnt");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_mnt from monitor";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "MNT001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_mnt");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "MNT00"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                a[0] = rs.getString("id_mnt");
                a[1] = rs.getString("kode_mnt");
                a[2] = rs.getString("nama_mnt");
                a[3] = rs.getString("merek_mnt");
                a[4] = rs.getString("harga_mnt");
                a[5] = rs.getString("stock_mnt");
                tabelMb.addRow(a);
            }
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_mnt !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("= Master Data Monitor = ");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update monitor SET kode_mnt ='"+txtKode.getText()+"', nama_mnt ='"+txtNama.getText()+"', merek_mnt ='"+cmbMerek.getSelectedItem()+"',harga_mnt ='"+txtHarga.getText()+"', stock_mnt ='"+txtStock.getText()+"' WHERE id_mnt ='"+txtID.getText()+"'";
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from monitor WHERE id_mnt='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into monitor(kode_mnt,nama_mnt,merek_mnt,harga_mnt,stock_mnt) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
