...
public class ReportDiskDrive extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_dd from diskdrive";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_dd");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_dd from diskdrive";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "DD0001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_dd");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "DD000"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            String sql = "select * from diskdrive";
            Statement stm = (Statement) conn.createStatement();
            ResultSet rs = stm.executeQuery(sql);
            while(rs.next()){
                Object[] a = new Object[6];
                a[0] = rs.getString("id_dd");
                a[1] = rs.getString("kode_dd");
                a[2] = rs.getString("nama_dd");
                a[3] = rs.getString("merek_dd");
                a[4] = rs.getString("harga_dd");
                a[5] = rs.getString("stock_dd");
                tabelMb.addRow(a);
            }
            tabelDiskDrive.setModel(tabelMb);
            tabelDiskDrive.getColumnModel().getColumn(0).setPreferredWidth(20);
            tabelDiskDrive.getColumnModel().getColumn(2).setPreferredWidth(350);
            tabelDiskDrive.getColumnModel().getColumn(5).setPreferredWidth(50);
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_dd !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        tabelDiskDrive = new javax.swing.JTable();
        ...
        tabelDiskDrive.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabelDiskDrive.getTableHeader().setReorderingAllowed(false);
        tabelDiskDrive.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelDiskDriveMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelDiskDrive);
        ...
        jLabel3.setText("= Master Data HDD/SDD = ");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update diskdrive SET kode_dd ='"+txtKode.getText()+"', nama_dd ='"+txtNama.getText()+"', merek_dd ='"+cmbMerek.getSelectedItem()+"',harga_dd ='"+txtHarga.getText()+"', stock_dd ='"+txtStock.getText()+"' WHERE id_dd ='"+txtID.getText()+"'";
    ...
    private void tabelDiskDriveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelDiskDriveMouseClicked
        int baris = tabelDiskDrive.rowAtPoint(evt.getPoint());
        
        String idMb = tabelDiskDrive.getValueAt(baris, 0).toString();
        txtID.setText(idMb);
        String kode = tabelDiskDrive.getValueAt(baris, 1).toString();
        txtKode.setText(kode);
        String nama = tabelDiskDrive.getValueAt(baris, 2).toString();
        txtNama.setText(nama);
        String merek = tabelDiskDrive.getValueAt(baris, 3).toString();
        cmbMerek.setSelectedItem(merek);
        String harga = tabelDiskDrive.getValueAt(baris, 4).toString();
        txtHarga.setText(harga);
        String stock = tabelDiskDrive.getValueAt(baris, 5).toString();
        txtStock.setText(stock);
    }//GEN-LAST:event_tabelDiskDriveMouseClicked
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from diskdrive WHERE id_dd='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into diskdrive(kode_dd,nama_dd,merek_dd,harga_dd,stock_dd) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
    ...
    private javax.swing.JTable tabelDiskDrive;
