...
public class ReportRam extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_ram from ram";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_ram");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_ram from ram";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "RM0001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_ram");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "RM000"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                a[0] = rs.getString("id_ram");
                a[1] = rs.getString("kode_ram");
                a[2] = rs.getString("nama_ram");
                a[3] = rs.getString("merek_ram");
                a[4] = rs.getString("harga_ram");
                a[5] = rs.getString("stok_ram");
                tabelMb.addRow(a);
            }
            tabelRam.setModel(tabelMb);
            tabelRam.getColumnModel().getColumn(0).setPreferredWidth(20);
            tabelRam.getColumnModel().getColumn(2).setPreferredWidth(350);
            tabelRam.getColumnModel().getColumn(5).setPreferredWidth(50);
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_ram !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        tabelRam = new javax.swing.JTable();
        ...
        tabelRam.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabelRam.getTableHeader().setReorderingAllowed(false);
        tabelRam.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelRamMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelRam);
        ...
        jLabel3.setText("= Master Data RAM = ");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update ram SET kode_ram ='"+txtKode.getText()+"', nama_ram ='"+txtNama.getText()+"', merek_ram ='"+cmbMerek.getSelectedItem()+"',harga_ram ='"+txtHarga.getText()+"', stok_ram ='"+txtStock.getText()+"' WHERE id_ram ='"+txtID.getText()+"'";
    ...
    private void tabelRamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelRamMouseClicked
        int baris = tabelRam.rowAtPoint(evt.getPoint());
        
        String idMb = tabelRam.getValueAt(baris, 0).toString();
        txtID.setText(idMb);
        String kode = tabelRam.getValueAt(baris, 1).toString();
        txtKode.setText(kode);
        String nama = tabelRam.getValueAt(baris, 2).toString();
        txtNama.setText(nama);
        String merek = tabelRam.getValueAt(baris, 3).toString();
        cmbMerek.setSelectedItem(merek);
        String harga = tabelRam.getValueAt(baris, 4).toString();
        txtHarga.setText(harga);
        String stock = tabelRam.getValueAt(baris, 5).toString();
        txtStock.setText(stock);
    }//GEN-LAST:event_tabelRamMouseClicked
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from ram WHERE id_ram='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into ram(kode_ram,nama_ram,merek_ram,harga_ram,stok_ram) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
    ...
    private javax.swing.JTable tabelRam;
