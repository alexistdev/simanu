...
public class ReportCase extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_casing from casing";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_casing");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_casing from casing";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "CS0001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_casing");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "CS000"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            String sql = "select * from casing";
            Statement stm = (Statement) conn.createStatement();
            ResultSet rs = stm.executeQuery(sql);
            while(rs.next()){
                Object[] a = new Object[6];
                a[0] = rs.getString("id_casing");
                a[1] = rs.getString("kode_casing");
                a[2] = rs.getString("nama_casing");
                a[3] = rs.getString("merek_casing");
                a[4] = rs.getString("harga_casing");
                a[5] = rs.getString("stock_casing");
                tabelMb.addRow(a);
            }
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_casing !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("= Master Data Motherboard = ");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update casing SET kode_casing ='"+txtKode.getText()+"', nama_casing ='"+txtNama.getText()+"', merek_casing ='"+cmbMerek.getSelectedItem()+"',harga_casing ='"+txtHarga.getText()+"', stock_casing ='"+txtStock.getText()+"' WHERE id_casing ='"+txtID.getText()+"'";
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from casing WHERE id_casing='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into casing(kode_casing,nama_casing,merek_casing,harga_casing,stock_casing) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
