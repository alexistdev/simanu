...
public class ReportVGA extends javax.swing.JInternalFrame {
    ...
    private void idTerakhir(){
        try{
            String sql = "select id_vga from vga";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
             
             while(rs.next()){
                 String dataku = rs.getString("id_vga");
    ...
    private void kodeTerakhir(){
        ...
        try{
            String sql = "select kode_vga from vga";
             pst = conn.prepareStatement(sql);
             ResultSet rs = pst.executeQuery();
             if(!rs.isBeforeFirst()){
                 String KodeTerbaru = "VG0001";
                 txtKode.setText(KodeTerbaru);
             }else{
                while(rs.next()){
                    String kodeku = rs.getString("kode_vga");
                    String dapatAngka= kodeku.replaceAll("[^0-9]", "");
                    int kodeBaru = Integer.parseInt(dapatAngka)+1;
                    String KodeTerbaru = "VG000"+kodeBaru;
    ...
    private void UpdateTabel(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                a[0] = rs.getString("id_vga");
                a[1] = rs.getString("kode_vga");
                a[2] = rs.getString("nama_vga");
                a[3] = rs.getString("merek_vga");
                a[4] = rs.getString("harga_vga");
                a[5] = rs.getString("stock_vga");
                tabelMb.addRow(a);
            }
    ...
    private void tampilkan_merek(){
        try{
             String sql = "select nama_merek from merek where kat_vga !=0";
             pst = conn.prepareStatement(sql);
             rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("= Master Data VGA = ");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try{
            Connection conn = null;
            Statement stmt = null;
            String sql = "Update vga SET kode_vga ='"+txtKode.getText()+"', nama_vga ='"+txtNama.getText()+"', merek_vga ='"+cmbMerek.getSelectedItem()+"',harga_vga ='"+txtHarga.getText()+"', stock_vga ='"+txtStock.getText()+"' WHERE id_vga ='"+txtID.getText()+"'";
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            if (String.valueOf(input).equals("0")){
                try{
                    Connection conn = null;
                    Statement stmt = null;
                    String sql = "DELETE from vga WHERE id_vga='"+txtID.getText()+"'";
                    conn = simanu.KoneksiDB.simanuDb();
                    stmt = conn.createStatement();
                    stmt.executeUpdate(sql);
                    UpdateTabel();
        ...
        if(txtKode.getText().equals("") ||
           ...
           cmbMerek.getSelectedItem().equals("=Pilih=")){
            ...
            try{
                ...
                conn = simanu.KoneksiDB.simanuDb();
                stmt = conn.createStatement();
                stmt.executeUpdate("insert into vga(kode_vga,nama_vga,merek_vga,harga_vga,stock_vga) values('"+kodeM+"','"+namaM+"','"+cmbM+"','"+hargaM+"','"+stockM+"')");
